...
namespace компилятор_2
{
    public partial class Form1 : Form
    {
        ...
        {
            RichTextBox rtb = files.AddNewTab(tabControl1); // Создаем новую вкладку и получаем rtb
            files.TrackChanges(rtb, EventArgs.Empty); // Начальное сохранение состояния
        ...
        private void toolStripButton5_Click(object sender, EventArgs e)
        {
            ...
            if (rtb != null)
            {
                files.RedoLastChange(rtb); // Восстанавливает одно полное изменение
            }
        }
